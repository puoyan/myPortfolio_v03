...
projects = [
  ...
  },
  {
    ...
    description:"MealPlaner - Team of 5 we used: Trello Bord in scrum style and Mindmap to organize our work, daily Zoom Meetings kept us up to date.using all tools that we learn in our course",
  ...
  },
  {
    ...
    tech:"PHP mySql - API",
    description:"Travel agency - using CRUD (create/read/update/delete)-google maps API to show the location",
  ...
  },
  {
    ...
    description:"Team of 3 we used: Trello Bord in scrum style and Mindmap to organize our work, daily Zoom Meetings kept us up to date.",
  ...
  },
  {
    ...
    description:"Creating a travel page using interactive cart functionality",
    git:"https://github.com/puoyan/Student_Database_Application",
    leftPosition:"timeline-inverted"
  },
  {
    ...
    description:"Creating a blog that utilizes dynamic page generation using classes and objects",
  ...
  },
  {
    ...
    description:"Generating a site dynamically from a .json file via javascript and using a sort function",
  ...
  },
   {
     ...
     description:"Using Bootstrapand SCSS, first JavaScript steps and getting familiar with the console",
   ...
   },
   {
    ...
    name:"Code Review 2",
    tech:"HTML SCSS",
    description:"Getting familiar with the basic concepts of dynamic pages and SCSS",
